...
// pub struct ToleranceGeometry<CS> {
//     pub coordinate_system: CoordinateSystem<CS>,
...
//     pub fn reset_with_new_coordinate_system(&mut self, coordinate_system: CoordinateSystem<CS>) {
