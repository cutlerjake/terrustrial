...
//     phantom2: std::marker::PhantomData<CS>,
// }

// impl<S, V, G, CS> GSGS<S, V, G, CS>
// where
//     S: SpatialQueryable<f32, G> + Sync,
//     V: VariogramModel + Sync,
//     G: Geometry<CS> + Sync + Clone,
//     CS: SimdRealField,
// {
...
//     where
//         GDB: GriddedDataBaseInterface<f32, f32> + std::marker::Sync,
//     {
