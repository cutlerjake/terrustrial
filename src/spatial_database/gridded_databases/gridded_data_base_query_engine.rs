...
// pub struct GriddedDataBaseOctantQueryEngine<'a, G, GDB, T, CS>
// where
//     G: Geometry<CS>,
//     GDB: GriddedDataBaseInterface<T, CS>,
//     CS: SimdRealField,
// {
...
//     pub(crate) pahntom2: std::marker::PhantomData<CS>,
// }

// impl<'a, G, GDB, T, CS> GriddedDataBaseOctantQueryEngine<'a, G, GDB, T, CS>
// where
//     G: Geometry<CS>,
//     GDB: GriddedDataBaseInterface<T, CS>,
//     CS: SimdRealField,
...
//             pahntom2: std::marker::PhantomData,
//         }
//     }
...
// impl<'a, G, GDB, T, CS> SpatialQueryable<T, G>
//     for GriddedDataBaseOctantQueryEngine<'a, G, GDB, T, CS>
// where
//     G: Geometry<CS>,
//     GDB: GriddedDataBaseInterface<T, CS>,
//     CS: SimdRealField,
