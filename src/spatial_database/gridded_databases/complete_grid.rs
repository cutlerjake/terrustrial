...
// pub struct CompleteGriddedDataBase<T, CS> {
//     pub raw_grid: RawGriddedDataBase<T, CS>,
// }

// impl<T, CS> CompleteGriddedDataBase<T, CS> {
//     pub fn new(
//         grid: Array3<T>,
...
// impl<T, CS> GriddedDataBaseInterface<T, CS> for CompleteGriddedDataBase<T, CS>
// where
//     T: Copy,
