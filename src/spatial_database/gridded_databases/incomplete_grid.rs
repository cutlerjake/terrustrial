...
// pub struct InCompleteGriddedDataBase<T, CS> {
//     pub raw_grid: RawGriddedDataBase<Option<T>, CS>,
// }

// impl<T, CS> InCompleteGriddedDataBase<T, CS> {
//     pub fn new(
//         grid: Array3<Option<T>>,
//         block_size: GridSpacing,
//         coordinate_system: CoordinateSystem<CS>,
//     ) -> Self {
...
// impl<T, CS> GriddedDataBaseInterface<T, CS> for InCompleteGriddedDataBase<T, CS>
// where
//     T: Copy,
//     CS: SimdValue + SimdRealField,
// {
