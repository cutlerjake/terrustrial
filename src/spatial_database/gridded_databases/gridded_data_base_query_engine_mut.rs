...
// pub struct GriddedDataBaseOctantQueryEngineMut<'a, G, GDB, T, CS>
// where
//     G: Geometry<CS>,
...
//     pub(crate) phantom2: std::marker::PhantomData<CS>,
// }

// impl<'a, G, GDB, T, CS> GriddedDataBaseOctantQueryEngineMut<'a, G, GDB, T, CS>
// where
//     G: Geometry<CS>,
//     GDB: GriddedDataBaseInterface<T, CS>,
//     CS: SimdRealField,
...
//     for GriddedDataBaseOctantQueryEngineMut<'a, G, GDB, T, CS>
// where
//     G: Geometry<CS>,
//     GDB: GriddedDataBaseInterface<T, CS>,
//     CS: SimdRealField,
